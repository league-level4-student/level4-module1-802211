...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public _00_SnakeGame() {
		int r1 = new Random().nextInt(WIDTH);
		int r2 = new Random().nextInt(HEIGHT);
		foodLocation = new Location(r1, r2);
	...
	private void setFoodLocation() {
		...
		int locX = new Random().nextInt(WIDTH);
		int locY = new Random().nextInt(HEIGHT);
